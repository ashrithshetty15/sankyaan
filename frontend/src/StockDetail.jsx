...
export default function StockDetail() {
  ...
  return (
    <div className="stock-detail-container">
      ...
      {/* Quality Scores Section - Above Chart */}
            ...
            content: (
              <>
                ...
                <div style={{ marginTop: '32px' }}>
                  <EventsTimeline symbol={stockData.symbol} />
                </div>
                ...
                <div style={{ marginTop: '24px' }}>
                  <PeerComparison
                    ...
                    currentStock={{
                      ...
                      sector: stockData.sector,
                      market_cap: marketCap,
                      pe_ratio: stockData.fundamentals?.pe_ratio,
                      roe: stockData.fundamentals?.roe,
                      roce: stockData.fundamentals?.roce,
                      dividend_yield: stockData.fundamentals?.dividend_yield,
                    }}
                  />
                </div>
              </>
