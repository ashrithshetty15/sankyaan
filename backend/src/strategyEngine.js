  ...
  for (const putSell of putSellCandidates) {
    for (const callSell of callSellCandidates) {
      ...
      alerts.push({
        ...
        expiry,
        legs: [
          { strike: putBuyStrike, type: 'PE', action: 'BUY', ltp: putBuy.pe.ltp, iv: putBuy.pe.iv, delta: putBuy.pe.delta, oi: putBuy.pe.oi, symbol: putBuy.pe.symbol },
          { strike: putSell.strike, type: 'PE', action: 'SELL', ltp: putSell.pe.ltp, iv: putSell.pe.iv, delta: putSell.pe.delta, oi: putSell.pe.oi, symbol: putSell.pe.symbol },
          { strike: callSell.strike, type: 'CE', action: 'SELL', ltp: callSell.ce.ltp, iv: callSell.ce.iv, delta: callSell.ce.delta, oi: callSell.ce.oi, symbol: callSell.ce.symbol },
          { strike: callBuyStrike, type: 'CE', action: 'BUY', ltp: callBuy.ce.ltp, iv: callBuy.ce.iv, delta: callBuy.ce.delta, oi: callBuy.ce.oi, symbol: callBuy.ce.symbol },
        ],
...
function scanBullPutSpreads(chain, spotPrice, ivRank, underlying, expiry) {
  ...
  for (const sell of sellCandidates) {
    ...
    alerts.push({
      ...
      expiry,
      legs: [
        { strike: buyStrike, type: 'PE', action: 'BUY', ltp: buy.pe.ltp, iv: buy.pe.iv, delta: buy.pe.delta, oi: buy.pe.oi, symbol: buy.pe.symbol },
        { strike: sell.strike, type: 'PE', action: 'SELL', ltp: sell.pe.ltp, iv: sell.pe.iv, delta: sell.pe.delta, oi: sell.pe.oi, symbol: sell.pe.symbol },
      ],
      max_profit: premiumCollected,
      max_loss: maxLoss,
      breakeven: [breakeven],
...
function scanBearCallSpreads(chain, spotPrice, ivRank, underlying, expiry) {
  ...
  for (const sell of sellCandidates) {
    ...
    alerts.push({
      ...
      expiry,
      legs: [
        { strike: sell.strike, type: 'CE', action: 'SELL', ltp: sell.ce.ltp, iv: sell.ce.iv, delta: sell.ce.delta, oi: sell.ce.oi, symbol: sell.ce.symbol },
        { strike: buyStrike, type: 'CE', action: 'BUY', ltp: buy.ce.ltp, iv: buy.ce.iv, delta: buy.ce.delta, oi: buy.ce.oi, symbol: buy.ce.symbol },
      ],
      max_profit: premiumCollected,
      max_loss: maxLoss,
      breakeven: [breakeven],
