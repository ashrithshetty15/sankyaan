...
async function fixMotilalPercentages() {
  try {
    console.log('🔄 Converting Motilal Oswal percentages from decimal to percentage format...\n');
    ...
    // Multiply all Motilal percentages by 100
    console.log('\n📊 Multiplying all Motilal Oswal percentages by 100...');
